...
namespace DataAccessLayer.Migrations
{
    ...
    [Migration("20230627104338_Added OrderForVendors Table")]
    partial class AddedOrderForVendorsTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Entitites.Models.OrderItems", b =>
                {
                    ...
                    b.Property<long>("OrdersForVendorsId")
                    ...
                    b.HasIndex("OrdersForVendorsId");

                    b.ToTable("OrderItems");
                });

            modelBuilder.Entity("Entitites.Models.OrdersForVendors", b =>
                {
                    b.Property<long>("OrdersForVendorsId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<long>("OrdersForVendorsId"));
                    ...
                    b.HasKey("OrdersForVendorsId");

                    b.HasIndex("OrderId");

                    b.ToTable("OrdersForVendors");
                });
            ...
            modelBuilder.Entity("Entitites.Models.OrderItems", b =>
                {
                    b.HasOne("Entitites.Models.OrdersForVendors", "OrdersForVendors")
                        .WithMany("OrderItems")
                        .HasForeignKey("OrdersForVendorsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("OrdersForVendors");
                });

            modelBuilder.Entity("Entitites.Models.OrdersForVendors", b =>
                {
                    b.HasOne("EntityLayer.Models.Order", "Order")
                        .WithMany("OrdersFromStores")
